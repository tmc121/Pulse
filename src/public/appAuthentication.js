            ...
            quickMenuManageButton.onClick(async () => {
                ...
                if (ms) {
                    ...
                    const manageElements = [
                        ...
                        selectOrNull('#manageTeam-AccountsRepeater'),
                        selectOrNull('#managerTeam-DisplayAccount-Item-Button'),
                        selectOrNull('#item-Team-CheckBox'),
                        selectOrNull('#manageTeam-SelectedItem-Display-Wrapper'),
                        selectOrNull('#manageTeam-SelectedItem-UserID'),
                        selectOrNull('#manageTeam-SelectedItem-FullName'),
                        selectOrNull('#manageTeam-SelectedItem-Email'),
